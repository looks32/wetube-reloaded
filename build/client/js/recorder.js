    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          ...
          actionBtn.addEventListener("click", _handleStart);
        case 33:
        case "end":
...
var _handleStart = function handleStart() {
  actionBtn.innerText = "Recording";
  actionBtn.disabled = true;
  actionBtn.removeEventListener("click", _handleStart);
  ...
  recorder.ondataavailable = function (event) {
    ...
    actionBtn.disabled = false;
    actionBtn.addEventListener("click", _handleDownload);
  };
  recorder.start();
  setTimeout(function () {
    recorder.stop();
